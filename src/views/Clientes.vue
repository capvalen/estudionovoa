	...
	<div >
		...
		<div id="resultadoClientes">
			<div class="py-2 px-4 border-bottom" @click="editarTodo(index)" v-for="(cliente, index) in clientes" :key="cliente.id">
				...
				<p>Tiene <strong class="text-danger">4</strong> casos activos <span id="spanVer" @click.stop="verCaso()" class="text-primary"><i class="bi bi-eye"></i></span> <span class="text-success float-end" @click.stop="sumarCaso(1)"><i class="bi bi-bookmark-plus"></i> </span></p>
			</div>
						...
						<div class="list-group">
						  <a href="#" class="list-group-item list-group-item-action " aria-current="true">
						    <div class="d-flex w-100 justify-content-between">
						      <h5 class="mb-1">Prueba de paternidad mediante ADN</h5>
						      <small>hoy</small>
						    </div>
								<p class="mb-1">Estado: <span class="text-success">En revisión</span></p>
						    <small class="text-muted">Registrador: Fiorela M.</small>
						    
						  </a>
						  <a href="#" class="list-group-item list-group-item-action">
						    <div class="d-flex w-100 justify-content-between">
						      <h5 class="mb-1">Ecografía de rutina</h5>
						      <small class="text-muted">hace 5 horas</small>
						    </div>
						    <p class="mb-1">Estado: <span class="text-success">Doctor analizando las imágenes</span></p>
						    <small class="text-muted">Registrador: Fiorela M.</small>
						  </a>
						  <a href="#" class="list-group-item list-group-item-action">
						    <div class="d-flex w-100 justify-content-between">
						      <h5 class="mb-1">Prueba de sangre de embarazo</h5>
						      <small class="text-muted">hace 3 meses</small>
						    </div>
						    <p class="mb-1">Estado: <span class="text-secondary">Resultado: Positivo</span></p>
						    <small class="text-muted">Registrador: Conor H.</small>
						  </a>
						</div>
