...
$sql="INSERT INTO `proceso`(`id`, `idCliente`, `caso`, `antecedentes`, `tipopago`, `precio`, `cuotas`, `plazos`, `fecha`, `registrado`, `documento`, `codigo`, `rutaDocumento`, `idUsuario`) VALUES
...
."', '{$_POST['codigo']}', '{$_POST['nombreRuta']}', {$_POST['idUsuario']});
